...
class IndexPage:
    def __init__(self, vocpath: Path | None = None) -> None:
        self.METADATA = {}
    ...
    def get_version_data(self) -> None:
...
def build_multirelease_index(voc_path: Path, out_path: Path) -> None:
    # load config
