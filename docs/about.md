...
See the project contributors listing and the Zenodo record for citation metadata and contributor details:

- [Project contributors](https://github.com/nfdi4cat/voc4cat-tool/graphs/contributors) on GitHub
- [Zenodo record](https://doi.org/10.5281/zenodo.8277925) (includes author and contributor metadata)

The lead maintainer is David Linke (GitHub: [dalito](https://github.com/dalito/)).
...
This project includes the [vocpub](https://linked.data.gov.au/def/vocpub) SHACL profile, which is licensed under the Creative Commons Attribution 4.0 International License (CC-BY 4.0) and was created by [Nicholas J. Car](https://orcid.org/0000-0002-8742-7730).
